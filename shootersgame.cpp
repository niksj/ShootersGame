 ...
 // setcolor(5);
  for(i=0;i<=400;i++)
  {
   circle(510-4*i,130,40) ;
   ellipse(510-4*i,260,0,360,50,90);
   ellipse(510-4*i,260,0,360,30,50);
   circle(555-4*i,350,20);
   circle(470-4*i,350,20);
   circle(568-4*i,200,20);
   circle(449-4*i,200,20);
   circle(595-4*i,175,10);
   circle(420-4*i,175,10);
   rectangle(592-4*i,167,596-4*i,80);
  // floodfill(520-4*i,90,5);
   rectangle(510-4*i,80,635-4*i,20);
   outtextxy(520-4*i,40," LOADING...");
   circle(550-4*i,100,10);
   circle(470-4*i,100,10);
   setfillstyle(2,5);
     int polypoints[8]={580-i,370,440-i,370,410-i,400,610-i,400};
   fillpoly(4,polypoints);
   circle(429-4*i,410,10);
   circle(591-4*i,410,10);
   circle(524-4*i,115,5);
   circle(496-4*i,115,5);
   arc(510-4*i,130,200,340,18);
...
//    putimage(14,190,handimage,OR_PUT);
    cleardevice();
    }
   void image1()         //done
    {
...
//    setcolor(RED);
  ...
  //  fillellipse(500,55,13,35);
   ...
   void image()    
    ...
    circle(490,150,25);
    setfillstyle(1,3);
    floodfill(490,150,BLUE);

    circle(500,60,25);
    setfillstyle(1,10);
    floodfill(500,60,BLUE);
    settextstyle(0,0,5);
   sprintf(buffer,"%c",2);
   ...
   arc(235,80,300,60,50);
   setlinestyle(0,1,2);
   line(225,80,305,80);
    line( 298,75,305,80)  ;
    line(298,85,305,80);
    settextstyle(3,0,3);
    outtextxy(315,66,"SHOOTERSGAME ");
    setcolor(BLUE);
    settextstyle(2,0,3);
    ...
    outtextxy(60,150," Rule 2 ð> There are 3 Levels Of The game.");
